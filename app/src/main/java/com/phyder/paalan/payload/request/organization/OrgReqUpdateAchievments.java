...
public class OrgReqUpdateAchievments {
    ...
    public static OrgReqUpdateAchievments get(String orgs, String achievementId, ArrayList<String> imgs, String description, String others, String subTitle, String title) {
        ...
        OrgReqUpdateAchievments createAchievments = new OrgReqUpdateAchievments();
        createAchievments.setData(data);
        createAchievments.setAction(Social.UPDATE_ACTION);
