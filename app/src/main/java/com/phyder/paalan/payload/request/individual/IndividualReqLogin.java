...
// */
//
//public class IndividualReqLogin {
//
...
//    private String type;
//
//    public static IndividualReqLogin get(String userid, String imeino, String password) {
//        Data data = new Data();
//        data.setImeino(imeino);
//        data.setUserid(userid);
//        data.setPassword(password);
//
//        IndividualReqLogin indivitualReqLogin = new IndividualReqLogin();
